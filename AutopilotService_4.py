...
def on_message(cli, userdata, message):
    ...
    sending_topic = "autopilotService4/" + origin # lo necesitaré para enviar las respuestas
...
client = mqtt.Client("autopilotService4")
dron = Dron()
client.on_message = on_message
client.on_connect = on_connect

client.connect(broker_address, broker_port)
client.subscribe('+/autopilotService4/#')
print ('autopilotService4 esperando peticiones')
client.loop_forever()
