...
def on_message(cli, userdata, message):
    ...
    sending_topic = "autopilotService2/" + origin # lo necesitaré para enviar las respuestas
...
client = mqtt.Client("autopilotService2")
dron = Dron()
client.on_message = on_message
client.on_connect = on_connect

client.connect(broker_address, broker_port)
client.subscribe('+/autopilotService2/#')
print ('autopilotService2 esperando peticiones')
client.loop_forever()
